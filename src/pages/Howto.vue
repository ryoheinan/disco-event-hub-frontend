    ...
    <div class="container mx-auto px-5">
      <div class="text-center">
        ...
        <section class="text-white mb-10">
          <h2 class="text-2xl mb-2 font-bold">このサイトについて</h2>
          <p>
        ...
        <section class="text-white mb-10">
          <h2 class="text-2xl mb-2 font-bold">使い方</h2>
          <p class="mb-5">
          ...
          <a
            href="https://discord.com/api/oauth2/authorize?client_id=852174545024843806&permissions=16&scope=bot"
            class="
              btn-bot
              py-2
              px-4
          ...
          <p class="mt-8 mb-5">
            ...
            作成画面へのリンクが表示され、サイト上で作成することができます。<br />
